...
const MOCK_CARDS = [
  { id:1,  question:'Paragrafta ana fikir nerede bulunur?',   answer:'Genellikle başta veya sonda; bazen tümüne yayılır.',                 card_type:'qa',  status:'published', course:1, chapter:1  },
  { id:2,  question:'Fiilimsi türleri nelerdir?',              answer:'İsim-fiil, sıfat-fiil, zarf-fiil.',                                  card_type:'qa',  status:'published', course:1, chapter:2  },
  { id:3,  question:'Mecaz anlam nedir?',                      answer:'Sözcüğün gerçek anlamı dışında kullanılmasıdır.',                    card_type:'def', status:'published', course:1, chapter:3  },
  { id:4,  question:'Kareler farkı formülü?',                  answer:'a² - b² = (a+b)(a-b)',                                              card_type:'qa',  status:'published', course:2, chapter:4  },
  { id:5,  question:'Hız-Zaman-Mesafe formülü?',               answer:'M = H × Z',                                                         card_type:'qa',  status:'published', course:2, chapter:5  },
  { id:6,  question:'Üçgende iç açılar toplamı?',              answer:'180°',                                                              card_type:'qa',  status:'published', course:2, chapter:6  },
  { id:7,  question:"Newton'un 1. Yasası?",                    answer:'Net kuvvet sıfırsa cisim durur ya da sabit hızla hareket eder.',     card_type:'qa',  status:'published', course:3, chapter:7  },
  { id:8,  question:'Atom numarası neyi gösterir?',            answer:'Proton sayısını.',                                                   card_type:'def', status:'pending',   course:3, chapter:8  },
  { id:9,  question:'Fotosentez denklemi?',                    answer:'6CO₂ + 6H₂O + ışık → C₆H₁₂O₆ + 6O₂',                             card_type:'qa',  status:'draft',     course:3, chapter:9  },
  { id:10, question:"Osmanlı'nın kuruluş yılı?",               answer:'1299.',                                                             card_type:'qa',  status:'published', course:4, chapter:10 },
  { id:11, question:'Empirizm nedir?',                         answer:'Bilginin kaynağının deney ve gözlem olduğunu savunan akım.',        card_type:'def', status:'draft',     course:4, chapter:12 },
  { id:12, question:'Faraday İndüksiyon Yasası?',              answer:'Değişen manyetik akı EMK indükler: EMK = -dΦ/dt.',                  card_type:'qa',  status:'published', course:5, chapter:14 },
  { id:13, question:'Türev tanımı?',                           answer:"f'(x) = lim(h→0)[f(x+h)-f(x)]/h",                                  card_type:'def', status:'published', course:6, chapter:17 },
  { id:14, question:'Tanzimat Edebiyatı başlangıç tarihi?',    answer:'1839 (Tanzimat Fermanı).',                                          card_type:'qa',  status:'published', course:7, chapter:19 },
  { id:15, question:"Kant'ın kategorik imperatifi?",           answer:'"Eyleminin ilkesi evrensel yasa olabilsin."',                       card_type:'def', status:'pending',   course:8, chapter:24 },
]
